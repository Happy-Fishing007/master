...
public class Generator {
    ...
    private static String url="jdbc:mysql://localhost:3307/test?serverTimezone=Asia/Shanghai";
        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("gjq") // 设置作者
                            ...
                            .outputDir("D:\\file\\springboot\\plrk\\src\\main\\java"); // 指定输出目录
                })
...
//                            .moduleName("springboot") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("student") // 设置需要生成的表名
                            .addTablePrefix("fwms_", "c_"); // 设置过滤表前缀
                })
